...
// To not pollute the global namespace a nested namespace called diag is used to
// include the .def file
namespace diag {
enum {
...
public:
  ...
  void report(SMLoc Loc, unsigned DiagID, Args &&...Arguments) {
    // Here the Msg can have variable parameters so a variadic template is used. 
